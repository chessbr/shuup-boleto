...
from shoop_boleto.models import BoletoBehaviorComponentMixin
from shoop_boleto_tests.utils import initialize
...
def test_boleto_not_exists():
    initialize()
    view_boleto_path = reverse("shoop:view_boleto", kwargs={"order_pk": 123, "order_key": "32131"})
