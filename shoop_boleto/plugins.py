...
from shoop.xtheme.plugins._base import TemplatedPlugin
...
class BoletoGeneratorCheckoutPlugin(TemplatedPlugin):
    ...
    """
    identifier = "shoop_boleto.checkout_boleto_generator"
    ...
    def get_context_data(self, context):
        ...
        try:
            ...
            if resolved.view_name == 'shoop:order_complete':
...
class BoletoInfoOrderHistoryPlugin(TemplatedPlugin):
    ...
    """
    identifier = "shoop_boleto.order_history_boleto_info"
    ...
    def get_context_data(self, context):
        ...
        try:
            ...
            if resolved.view_name == 'shoop:show-order':
