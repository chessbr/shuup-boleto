...
from shoop.core.models._service_base import ServiceBehaviorComponent
...
class BoletoBehaviorComponentMixin(models.Model):
    ...
    def get_context_data(self, service, order):
        ...
        # quando Shoop BR estiver instalado
        if "shoop_br" in settings.INSTALLED_APPS:
...
class StoredBoleto(models.Model):
    order = models.OneToOneField('shoop.Order',
                                 related_name='boleto',
