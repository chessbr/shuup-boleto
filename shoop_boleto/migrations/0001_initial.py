...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shoop', '0030_staffonlybehaviorcomponent'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('paymentprocessor_ptr', models.OneToOneField(to='shoop.PaymentProcessor', serialize=False, auto_created=True, primary_key=True, parent_link=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('bank_service', enumfields.fields.EnumField(serialize=False, primary_key=True, enum=shoop_boleto.constants.BankService, verbose_name='Serviço', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('servicebehaviorcomponent_ptr', models.OneToOneField(to='shoop.ServiceBehaviorComponent', serialize=False, auto_created=True, primary_key=True, parent_link=True)),
                ...
                ('especie_doc', enumfields.fields.EnumIntegerField(enum=shoop_boleto.constants.DocumentType, verbose_name='Espécie do documento', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(enum=shoop_boleto.constants.BoletoStatus, verbose_name='Situação', blank=True, default=0)),
                ('bank_service', enumfields.fields.EnumField(enum=shoop_boleto.constants.BankService, verbose_name='Serviço', max_length=10)),
                ...
                ('total_value', shoop.core.fields.MoneyValueField(verbose_name='Valor do Boleto', decimal_places=9, max_digits=36, editable=False, default=0)),
                ('payment_date', models.DateTimeField(null=True, verbose_name='Data do pagamento', blank=True)),
                ('payment_amount_value', shoop.core.fields.MoneyValueField(verbose_name='Valor pago', decimal_places=9, max_digits=36, editable=False, default=0)),
                ('order', models.OneToOneField(related_name='boleto', verbose_name='Pedido', to='shoop.Order')),
            ],
            options={
                'verbose_name': 'Boleto bancário',
                'verbose_name_plural': 'Boletos bancários',
